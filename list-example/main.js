...
Elm.Elements.make = function (_elm) {
   ...
   if (_elm.Elements.values) return _elm.Elements.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var elements = _U.list([{name: "Frank Underwood",rank: 12}
                          ,{name: "Franziska Schneider",rank: 2}
                          ,{name: "Pierinna Beeli",rank: 1}
                          ,{name: "Aaron Mannhart",rank: 0}
                          ,{name: "Bianca Held",rank: 1}
                          ,{name: "Fabian Dennler",rank: 3}
                          ,{name: "Yoloista Yoloer",rank: 20000}
                          ,{name: "Marvin",rank: 42}
                          ,{name: "Taylor Swift",rank: 4}
                          ,{name: "SecuriTay",rank: 666}
                          ,{name: "Nino Oswald",rank: 12}
                          ,{name: "David Müller",rank: 6}
                          ,{name: "Tobias Ackermann",rank: 1}
                          ,{name: "Tamara Graf",rank: 8}
                          ,{name: "Anita Bucher",rank: 7}
                          ,{name: "Anja Hug",rank: 3}
                          ,{name: "Sandra Grünenfelder",rank: 8}
                          ,{name: "Susanne Marti",rank: 0}
                          ,{name: "Vivianne Stricker",rank: 7}
                          ,{name: "Natali Kaufmann",rank: 1}]);
   return _elm.Elements.values = {_op: _op,elements: elements};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var genTd = function (element) {
      return A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text(element.name)])),A2($Html.td,_U.list([]),_U.list([$Html.text($Basics.toString(element.rank))]))]));
   };
   ...
   _U.list([A2($Html.thead,
           ...
           _U.list([A2($Html.tr,
           _U.list([]),
           _U.list([A2($Html.th,_U.list([]),_U.list([$Html.text("Name")])),A2($Html.th,_U.list([]),_U.list([$Html.text("Rank")]))]))]))
           ,A2($Html.tbody,_U.list([]),A2($List.map,genTd,$Elements.elements))]));
   return _elm.Main.values = {_op: _op,genTd: genTd,main: main};
};
